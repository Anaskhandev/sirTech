						...
						?>
								<div class="zbz-pricing-box <?php echo !empty($row['featured']) ? $row['featured'] : ''; ?> col-sm-6 col-md-3" data-appear="slideInUp" data-disappear="slideOutUp" data-delay="<?php echo $i; ?>">
									<div class="inner">
										...
										<div class="price">
											<ul>
												<li><strong><?php echo $row['users']; ?></strong> <?php echo $row['users_label']; ?></li>
												<li><strong><?php echo $row['space']; ?></strong> <?php echo $row['space_label']; ?></li>
												<li><strong><?php echo $row['bandwidth']; ?></strong> <?php echo $row['bandwidth_label']; ?></li>
												<?php if (!empty($row['mysql'])) { ?>
													<li><strong><?php echo  $row['mysql']; ?></strong> <?php echo $row['mysql_label']; ?></li>
												<?php
												}
												?>
												<li><strong><?php echo $row['support']; ?></strong> <?php echo $row['support_label']; ?></li>
												<?php if (!empty($row['support2'])) { ?>
													<li><strong><?php echo  $row['support2']; ?></strong> <?php echo $row['support2_label']; ?></li>
												<?php
												}
												?>
											</ul>
		...
		<div class="zbz-slide-inner">
			<div class="zbz-slide-content zbz-on-top">
				<div class="container">
					...
					<button id="open-btn" class="btn btn-ghost btn-default btn-lg">
					...
					<div id="modal-container">
						<div id="modal">
							<form id="inter_form" enctype="multipart/form-data">
								...
								<div class="form-group col-lg-12 Installation Installation_Surface">
									<label class="col-lg-12 Surface">Installation Surface</label>
									<div class="form-group col-lg-2">
										<input type="radio" id="Zinc" name="Installation_Surface" value="Zinc">
										<label for="Zinc" class="sub_labels">Zinc</label>
									</div>
									<div class="form-group col-lg-2">
										<input type="radio" id="Board" name="Installation_Surface" value="Board">
										<label for="Board" class="sub_labels">Board</label>
									</div>
									<div class="form-group col-lg-2">
										<input type="radio" id="Concrete" name="Installation_Surface" value="Concrete">
								...
								<div class="form-group col-lg-12 Installation Ownership">
									<label class="col-lg-12 Surface">Premises Ownership</label>
									<div class="form-group col-lg-2">
										<input type="radio" id="Owned" value="Owned" name="Ownership">
										<label for="Owned" class="sub_labels">Owned</label>
									</div>
									<div class="form-group col-lg-2">
										<input type="radio" id="Rented" value="Rented" name="Ownership">
										<label for="Rented" class="sub_labels">Rented</label>
									</div>
									<div class="form-group col-lg-2">
										<input type="radio" id="Leased" value="Leased" name="Ownership">
								...
								<div class="form-group col-lg-6 mt-5">
									<label class="year col-lg-12 px-0">Tenure Of Employment: </label>
								...
								<div class="col-lg-12">
									<div class="form-group col-lg-6 px-0">
										<label class="year col-lg-12 px-0">How long have you been living at the premises?</label>
										<div class="form-group col-lg-6 px-0">
									...
									<div class="form-group col-lg-6 Account">
										<label class="Surface px-0 col-lg-12">Type of Account: </label>
										<div class="form-group col-lg-6">
											<input type="radio" id="residential" name="Account" value="Residential">
											<label for="residential" class="sub_labels">Residential</label>
										</div>
										<div class="form-group col-lg-6">
											<input type="radio" id="commercial" name="Account" value="Commercial">
											<label for="commercial" class="sub_labels">Commercial</label>
										</div>
									</div>
								</div>
								<div class="form-group button_div col-lg-12">
									<button class="col-lg-6 mx-auto btn-lg btn btn-default btn-modal"> Submit</button>
								</div>
							</form>
