...
<div class="row">
    <div class="col-md-12">
        <div class="main-card mb-3 card">
            <div class="card-header d-flex justify-content-between">Footer <span class="alert_message"></span>
                <a href="./add_footer.php" class="btn btn-primary  <?php if ($res->num_rows > 0) {
                                                                        echo 'd-none';
                                                                    } ?>">Add </a>
            </div>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-success" href="add_footer.php?header_id_admin=<?php echo $row['id']; ?>"><i class="metismenu-icon fa-regular fa-pencil mr-2"></i>Edit</a>
                                        <a class="btn btn-outline-danger" href="footer.php?header_id_delete=<?php echo $row['id']; ?>"><i class="metismenu-icon fa-regular fa-trash mr-2"></i>Delete</a>
