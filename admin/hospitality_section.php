...
<div class="row">
    <div class="col-md-12">
        <div class="main-card mb-3 card">
            <div class="card-header d-flex justify-content-between">Hospitality Page <span class="alert_message"></span>
                <a href="./add_about.php?sec=<?php echo $sec; ?>" class="btn btn-primary 
                <?php
                if ($res->num_rows > 3) {
                    echo 'd-none';
                } ?>">Add </a>
