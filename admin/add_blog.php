    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            ...
            <form id="<?php echo $button; ?>">
                ...
                <div class="position-relative row form-group">
                    <label for="exampleTitle" class="col-sm-2 col-form-label">
                        <input class="form-control" name="users_label" value="<?php echo !empty($row['users_label']) ? $row['users_label'] : ''; ?>" placeholder="Enter label" />
                    </label>
                    <div class="col-sm-10">
                ...
                <div class="position-relative row form-group">
                    <label for="exampleTitle" class="col-sm-2 col-form-label">
                        <input class="form-control" name="space_label" value="<?php echo !empty($row['space_label']) ? $row['space_label'] : ''; ?>" placeholder="Enter label" />
                    </label>
                    <div class="col-sm-10">
                ...
                <div class="position-relative row form-group">
                    <label for="exampleTitle" class="col-sm-2 col-form-label">
                        <input class="form-control" name="bandwidth_label" value="<?php echo !empty($row['bandwidth_label']) ? $row['bandwidth_label'] : ''; ?>" placeholder="Enter label" />
                    </label>
                    <div class="col-sm-10">
                ...
                <div class="position-relative row form-group">
                    <label for="exampleTitle" class="col-sm-2 col-form-label">
                        <input class="form-control" name="mysql_label" value="<?php echo !empty($row['mysql_label']) ? $row['mysql_label'] : ''; ?>" placeholder="Enter label" />
                    </label>
                    <div class="col-sm-10">
                ...
                <div class="position-relative row form-group">
                    <label for="exampleTitle" class="col-sm-2 col-form-label">
                        <input class="form-control" name="support_label" value="<?php echo !empty($row['support_label']) ? $row['support_label'] : ''; ?>" placeholder="Enter label" />
                    </label>
                    <div class="col-sm-10">
                ...
                <div class="position-relative row form-group">
                    <label for="exampleTitle" class="col-sm-2 col-form-label">
                        <input class="form-control" name="support2_label" value="<?php echo !empty($row['support2_label']) ? $row['support2_label'] : ''; ?>" placeholder="Enter label" />(Optional)
                    </label>
                    <div class="col-sm-10">
